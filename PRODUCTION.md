...
For an HTTP-only private smoke test, set `COOKIE_SECURE=false`, keep `HTTP_PORT=8090`, and browse to
`http://127.0.0.1:8090` from the host. Never use this HTTP mode over the public internet.
